...
export const LEAN_PROTEINS = [
  ...
  'Elk',
  'Ground beef', 'Greek yogurt (plain non-fat)',
  'Lean beef', 'Lean pork', 'Lobster',
  'Ostrich',
  'Protein bar', 'Protein powder',
  'Ribeye', 'Redfish',
  'Salmon', 'Scallops', 'Sirloin', 'Steak',
  'Tilapia', 'Trout', 'Tuna', 'Turkey breast',
  'Venison',
  'Whey protein',
];
...
export const STARCHY_CARBOHYDRATES = [
  'Acorn squash', 'Basmati rice', 'Black beans', 'Black Eyed Peas', 'Brown rice', 'Bulgur', 'Buckwheat',
  'Cannellini beans', 'Chickpeas', 'Corn',
  'Delicata squash',
  'Fingerling', 'French fries',
  'Garbanzo beans',
  'Jasmine rice',
  'Kidney beans',
  'Lentils', 'Lima beans', 'Millet',
  'Navy beans',
  'Oatmeal', 'Oats (steel cut)',
  'Parsnips',
  'Peas', 'Pinto beans', 'Plantain',
  'Potato salad', 'Purple',
  'Red potatoes', 'Russet',
  'Spelt',
  'Sweet potatoes',
  'Tortilla (corn only — flour removed)',
  'Wild rice',
  'Yukon Gold',
];
...
export const FIBROUS_VEGETABLES = [
  ...
  'Asparagus',
  'Bean sprouts', 'Beets', 'Bok choy', 'Broccoli', 'Brussels sprouts',
  'Cabbage', 'Carrots', 'Cauliflower', 'Celery', 'Celery root', 'Cucumbers',
  'Eggplant',
  'Fennel',
  'Green beans', 'Green lettuce (sparingly)',
  'Jicama',
  'Kale',
  'Leeks',
  'Mushrooms',
  'Onions',
  'Peppers', 'Poblano peppers',
  'Radishes',
  'Spinach',
  'Tomatoes', 'Turnips',
  'Water chestnuts',
...
export const HEALTHY_FATS = [
  'Almonds (3 small handfuls male, 2 small handfuls female)',
