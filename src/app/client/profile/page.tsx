        ...
        <div className="p-4 rounded-xl bg-brand-charcoal/80 border border-brand-cream/10">
            ...
            <div className="flex-1 pr-4">
              ...
              <p className="text-brand-cream/40 text-xs mt-1">
                {client.allergy_discovery_enabled
                  ? 'ON — 1️⃣ Log your meals 2️⃣ Tell me how you feel (bloated / pain / fine) 3️⃣ I find patterns and suggest foods to avoid'
          ...
          {client.allergy_discovery_enabled && (
            <div className="mt-4 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <ol className="text-brand-cream/70 text-sm space-y-1 mb-3 pl-0 list-none">
          ...
          {!showSecurity ? (
            <div className="space-y-2">
              <div className="flex justify-between py-2 border-b border-brand-cream/10">
                ...
                <span className="text-brand-cream text-sm">{client.email}</span>
              </div>
                  ...
                  <button
                    onClick={async () => {
                      ...
                      try {
                        ...
                        const data = await res.json();
                        if (res.ok) {
                          const updated = { ...client, email: newEmail };
                          setClient(updated);
